...
public class JumpFlipTactician extends Tactician {
  ...
  JumpFlipTactician(Agc bot, TacticManager tacticManager) {
    super(bot, tacticManager);
  }

  private static ImmutableList<Pair<ControlsOutput, CarData>> plannedControls;
  ...
  private void renderPredictionForFrame(float elapsedSeconds) {
    Optional<Pair<ControlsOutput, CarData>> prediction = plannedControls.stream()
  ...
  private ImmutableList<Pair<ControlsOutput, CarData>> planJumpFlip(CarData car, BallData ball) {
    ImmutableList.Builder<Pair<ControlsOutput, CarData>> controlsListBuilder = ImmutableList.builder();
  ...
  private static void planFrame(CarData car, BallData ball, ControlsOutput output, JumpManager jumpManager) {
    if (false) return;
